            ...
            if(lineItem.Exchange_Rate__c!=null){
                if(lineItem.Exchange_Rate__c==1){
                    ...
                    if(lineItem.Comm_Tax_Amount__c!=null){
                        ...
                        lineItem.Comm_Tax_Amount_Local__c = lineItem.Comm_Tax_Amount_Local__c.setScale(2);
                        
                        if(baseForeignCurrencyRate>0){
                            lineItem.Comm_Tax_Amount_Foreign__c = lineItem.Comm_Tax_Amount_Local__c/baseForeignCurrencyRate;
                            lineItem.Comm_Tax_Amount_Foreign__c = lineItem.Comm_Tax_Amount_Foreign__c.setScale(2);
                        }
                    }                                        
                    ...
                    if(lineItem.Amount__c!=null){
                        ...
                        lineItem.Amount_Local__c = lineItem.Amount_Local__c.setScale(2);
                        lineItem.Amount_Foreign__c = lineItem.Amount_Foreign__c.setScale(2);
                    }
                    if(lineItem.Comm_Tax_Amount__c!=null){
