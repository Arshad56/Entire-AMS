({
	...
	init : function(component, event, helper) {
		...
		var sub;
		if(envelope.subject.length > 75){
			envelope.shortSubject =envelope.subject.substring(0,15) +"......."+ envelope.subject.substring(75,envelope.subject.length);
		}
		else{
			envelope.shortSubject =envelope.subject;
		}
		
		var envelopeUpdated = Object.assign({}, envelope);
		component.set("v.envelope",envelopeUpdated);
